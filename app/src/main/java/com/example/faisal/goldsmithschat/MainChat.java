...
public class MainChat extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        channel = "#Common";
        ChatActivity.bot.joinChannel("#Common");
        ...
        //navMenuIcons = getResources().getDrawable(R.drawable.icon);
//                .obtainTypedArray(R.array.nav_drawer_icons);
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            case 0:
                b.putString("ChatSection", "Common");
                break;
            case 1:
                b.putString("ChatSection", "Computing");
                break;
            case 2:
                b.putString("ChatSection", "Art");
                break;
            case 3:
                b.putString("ChatSection", "Design");
                break;
            case 4:
                b.putString("ChatSection", "History");
                break;
    ...
    /*public void send(View v)
    {
        ...
        if(!word.equals(""))
        {
            ...
            ChatActivity.bot.sendMessage("#Common", word);
